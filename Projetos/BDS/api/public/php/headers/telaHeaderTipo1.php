            ...
            <body>
                ...
                <aside class="menuLateral" id="menuLateral">
                    ...
                    <ul>
                        ...
                        <hr />
                        <li><a href="#" onclick="enviarRequisicao('/produtos/promocao')">BLUSAS</a></li>
                        <hr />
                        <li><a href="#" onclick="enviarRequisicao('/produtos/promocao/marca')">VESTIDOS</a></li>
                        <hr />
                        ...
                        <hr />
                        <li>
                            <a href="#" onclick="enviarRequisicao('/usuarios')">MINHA CONTA</a>
                        </li>
                        <hr />
                        <li>
                ...
                <?php
            require_once $telaPesquisaAvancada;
            ?>